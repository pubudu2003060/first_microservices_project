package com.pubudu.microservice.api_gateway.routes;
...
public class Routes {
    ...
    public RouterFunction<ServerResponse> productServiceRoute(){
        return GatewayRouterFunctions.route("product_service")
                ...
                .filter(circuitBreaker("productServiceBraker", URI.create("forward:/fallbackroute")))
                .build();
    }
    ...
    public RouterFunction<ServerResponse> orderServiceRoute(){
        return GatewayRouterFunctions.route("order_service")
                ...
                .filter(circuitBreaker("orderServiceBraker", URI.create("forward:/fallbackroute")))
                .build();
    }
    ...
    public RouterFunction<ServerResponse> inventryServiceRoute(){
        return GatewayRouterFunctions.route("inventry_service")
                .route(RequestPredicates.path("/api/inventry"), HandlerFunctions.http("http://localhost:8082"))
                .filter(circuitBreaker("inventryServiceBraker", URI.create("forward:/fallbackroute")))
                .build();
    }
